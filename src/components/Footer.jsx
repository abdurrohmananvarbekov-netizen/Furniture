const Footer = () => {
  return (
    <footer className="bg-white">
      <div className="bg-[#F2F5FF] py-20 text-center">
        <h2 className="text-3xl font-bold mb-4">Join Our Mailing List</h2>
        <p className="text-gray-500 mb-8">Sign up to receive inspiration, product updates,<br /> and special offers from our team.</p>
        ...
        <div className="max-w-[1260px] mx-auto flex flex-col md:flex-row gap-20">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-4 gap-4">
              {[1, 2, 3, 4].map(i => (
                <img key={i} src={`/insta${i}.png`} className="w-full aspect-square object-cover rounded-md hover:opacity-75 cursor-pointer transition-all" />
              ))}
            </div>
          </div>
        </div>
